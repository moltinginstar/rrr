...
const Rotation = UpdateRotationWorkflow.addStep(
  GetRotationFunction,
  {
...
const RotationForm = UpdateRotationWorkflow.addStep(
...
UpdateRotationWorkflow.addStep(
  Schema.slack.functions.SendEphemeralMessage,
  {
    ...
    message:
      `The rotation \`${RotationForm.outputs.name}\` was successfully updated! :white_check_mark:`,
  },
);
